...
groupOptions = [{'label': i, 'value': i}
                for i in production['Agent Group'].unique()]
manager_options = [{'label': i, 'value': i}
                   for i in production['Manager'].unique()]
...
def update_dropdown(selected_manager):
    ...
    agent_options = [{'label': i, 'value': i}
                     for i in filtered_production['Agent Name'].unique()]
...
def update_graph(selected_agent, selected_data):
    filtered_production = production[production['Agent Name']
                                     == selected_agent]
